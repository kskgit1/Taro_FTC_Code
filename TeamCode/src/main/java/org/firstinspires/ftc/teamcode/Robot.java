...
public abstract class Robot {
    ...
    public abstract void move(Gamepad gamepad1, Gamepad gamepad2, double robotAngle, Telemetry telemetry);
...
class DrivetrainTeleOp extends Robot {
    ...
    @Override
    public void move (Gamepad gamepad1, Gamepad gamepad2, double robotAngle, Telemetry telemetry) {

        this.robotAngle = robotAngle;

        double desiredAngle = getAngle(gamepad1.left_stick_x, gamepad1.left_stick_y, telemetry);

        double radius = getRadius(gamepad1.left_stick_x, gamepad1.left_stick_y);

        telemetry.addData("desiredAngle", desiredAngle);

        fr.setPower(getPowerRed(desiredAngle - robotAngle) * radius);
        bl.setPower(getPowerRed(desiredAngle - robotAngle) * radius);
        ...
        fl.setPower(getPowerBlue(desiredAngle - robotAngle) * radius);
        br.setPower(getPowerBlue(desiredAngle - robotAngle) * radius);

        telemetry.addData("Blue power", getPowerBlue(desiredAngle - 0) );
        telemetry.addData("Red power", getPowerRed(desiredAngle - 0) );
    ...
    public static double getAngle(double x, double y, Telemetry telemetry) {
        double angle = 0;
        //c = square root of x squared plus y square
...
//
//    @Override
//    public void move(Gamepad gamepad1, Gamepad gamepad2, double robotAngle) {
